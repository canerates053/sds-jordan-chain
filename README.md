...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20496573.svg)](https://doi.org/10.5281/zenodo.20496573)

Numerical ancillary files for:
> **Microlocal Spectral Bifurcation in Schwarzschild–de Sitter Geometry**
> Caner Ateş (2026)
> [https://doi.org/10.5281/zenodo.20496573](https://doi.org/10.5281/zenodo.20496573)
...
| `schwarzian.py`         | Appendix B.2 — critical point, S\_x(r^c), Q^Schw\_31                | ✓      |
...
The paper reports these same WKB-normalized values.
...
| `inner_product_e3e1.py` | Was a copy of jordan\_chain.py, not an independent check                                                                               | Added finite-difference residual cross-check (Method B)                |
...
```
Ateş, C. (2026). Microlocal Spectral Bifurcation in Schwarzschild–de Sitter Geometry.
Zenodo. https://doi.org/10.5281/zenodo.20496573
```
